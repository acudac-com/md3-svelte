...
<Col wFull class="gap-2 p-2 md:gap-3 md:p-3">
	...
	<Container hFit wFull>
		...
		<p>
			3. Pick and export your theme as CSS using the <a
				class="text-primary"
		...
		<p>4. Override the following files' content with the provided code.</p>
		<Row class="pl-4" gaps>
			<p>src/app.html</p>
		...
		<p>
			5. Combine <Link href="/layouts">Layouts</Link> and <Link href="/components">Components</Link>
